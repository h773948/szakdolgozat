...
public class RunMKDaily {


    public static int mkstatDaily(List<Double> numList) {
        int invC = 0;
        int count = 0;
    ...
    public static double getSignificanceDaily(List<Double> numList) {
        //mann kendall statisztika, invC
        int S = mkstatDaily(numList);
        double variance;
        ...
        Map<Double, Long> countOfDuplicatesMap = new HashMap<>();

        for (Double value : numList) {
            if (countOfDuplicatesMap.containsKey(value)) {
                countOfDuplicatesMap.put(value, countOfDuplicatesMap.get(value) + 1);
            } else {
                countOfDuplicatesMap.put(value, 1l);
            }
        }
...
*/
        ...
        //szintén előjelek tesztelésére
        return Zstat;
        //ezt vissza kell rakni
        //return 0;
    }
